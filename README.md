# 🌱 Growspent — Grow From What You Spend

**Turn your everyday spending into effortless investing.**  
Growspent automatically rounds up or adds a small % from each transaction and invests it intelligently based on your cash flow, goals, and risk profile.

> *"Money shouldn’t be something you manage — it should quietly grow with you."*
...
|:------|:-----|:------------|
| **Phase 1** | Validation | Launch waitlist, collect first 100 sign-ups |
| **Phase 2** | Simulation App | Connect Plaid sandbox, show “what-if” investing |
| **Phase 3** | Alpha Build | Integrate brokerage API (DriveWealth / Alpaca) |
| **Phase 4** | Beta Release | Launch AI-driven auto-invest with real accounts |
